...
| REL-05 | Windows Authenticode signing | blocked | P1 | M | SignPath templates and fail-closed CI are ready; activation requires Foundation acceptance, dashboard resources, GitHub App access, and repository credentials. |
